...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { filling: @donut.filling, flavor: @donut.flavor, icing: @donut.icing, image: @donut.image, name: @donut.name, price: @donut.price, sprinkles: @donut.sprinkles }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { filling: @donut.filling, flavor: @donut.flavor, icing: @donut.icing, image: @donut.image, name: @donut.name, price: @donut.price, sprinkles: @donut.sprinkles }
    assert_redirected_to donut_path(assigns(:donut))
  end
